...
public class FrontAugiveController {
    ...
    Radius init_radius(Body_Data body_data){
        ...
        return new Front_Augive_Radius(start,end,diameter);
    }
    ...
    @FXML
    void enable_common_ratio(ActionEvent event){
    ...
    public void show_graph(Generatrix_Radius_Data data){
        ...
        drawer.draw_radius(data.radius, data.separator, "_resources/front_augive_graph");
        Image img = new Image(new File("./_resources/front_augive_graph.PNG").toURI().toString());
