...
import enums.Angular_Radius_Type;
...
public class Controller {
    ...
    void click(MouseEvent event) {
        ...
        Separator ang_sep = new Even_Separator(ang_rad,16);
        ...
        Separator cyl2_sep = new Even_Separator(cyl2_rad,4);

        Radius back_rad = new Back_Augive_Radius(4,5,0.3);
        Separator back_sep = new Even_Separator(back_rad,7);
       ...
       // Ch_body.add_part(conic_part);
        ...
        Ch_body.init_Grid();
       // Ch_body.curve_tail(1,Math.PI/4);
